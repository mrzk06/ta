...
public anywheresoftware.b4a.objects.TabHostWrapper _about = null;
...
vis = vis | (current_pos.mostCurrent != null);
vis = vis | (pencarian.mostCurrent != null);
vis = vis | (report.mostCurrent != null);
vis = vis | (radius.mostCurrent != null);
vis = vis | (informasi.mostCurrent != null);
vis = vis | (location_route.mostCurrent != null);
vis = vis | (gallery.mostCurrent != null);
vis = vis | (takecam.mostCurrent != null);
vis = vis | (takevid.mostCurrent != null);
vis = vis | (scrollview.mostCurrent != null);
return vis;}
public static String  _about_click() throws Exception{
 //BA.debugLineNum = 110;BA.debugLine="Sub about_Click";
 //BA.debugLineNum = 112;BA.debugLine="End Sub";
return "";
}
public static String  _activity_create(boolean _firsttime) throws Exception{
 //BA.debugLineNum = 44;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
 //BA.debugLineNum = 46;BA.debugLine="If FirstTime Then 'jika aplikasi pertama diaktifk";
if (_firsttime) { 
 //BA.debugLineNum = 47;BA.debugLine="Activity.LoadLayout(\"splash\")";
mostCurrent._activity.LoadLayout("splash",mostCurrent.activityBA);
 //BA.debugLineNum = 48;BA.debugLine="AnimSplash 'Panggil function animasi splash scre";
_animsplash();
 //BA.debugLineNum = 49;BA.debugLine="tmSplash.Initialize(\"tmSplash\",3500) 'panggil ev";
_tmsplash.Initialize(processBA,"tmSplash",(long) (3500));
 //BA.debugLineNum = 50;BA.debugLine="tmSplash.Enabled = True 'aktifkan timer";
_tmsplash.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 }else {
 //BA.debugLineNum = 52;BA.debugLine="Activity.RemoveAllViews 'Hapus Design pada layou";
mostCurrent._activity.RemoveAllViews();
 //BA.debugLineNum = 53;BA.debugLine="Activity.LoadLayout(\"home\") 'Set layout lyHome";
mostCurrent._activity.LoadLayout("home",mostCurrent.activityBA);
 //BA.debugLineNum = 55;BA.debugLine="ScrollView1.Panel.LoadLayout(\"homeket\")";
mostCurrent._scrollview1.getPanel().LoadLayout("homeket",mostCurrent.activityBA);
 //BA.debugLineNum = 56;BA.debugLine="about.Initialize(\"about\")";
mostCurrent._about.Initialize(mostCurrent.activityBA,"about");
 //BA.debugLineNum = 57;BA.debugLine="about.AddTab(\"Home\",\"scroll.bal\")";
mostCurrent._about.AddTab(mostCurrent.activityBA,"Home","scroll.bal");
 //BA.debugLineNum = 58;BA.debugLine="about.AddTab(\"About\",\"about.bal\")";
mostCurrent._about.AddTab(mostCurrent.activityBA,"About","about.bal");
 };
...
public static String  _animsplash() throws Exception{
 //BA.debugLineNum = 81;BA.debugLine="Sub AnimSplash()";
 //BA.debugLineNum = 82;BA.debugLine="If btAnim.IsInitialized Then";
if (mostCurrent._btanim.IsInitialized()) { 
 //BA.debugLineNum = 83;BA.debugLine="btAnim.Stop(ImageView1)";
mostCurrent._btanim.Stop((android.view.View)(mostCurrent._imageview1.getObject()));
 //BA.debugLineNum = 84;BA.debugLine="Activity.Invalidate";
mostCurrent._activity.Invalidate();
 };
 //BA.debugLineNum = 86;BA.debugLine="btAnim.InitializeTranslate( \"AllFunction.btAnim\",";
mostCurrent._btanim.InitializeTranslate(mostCurrent.activityBA,"AllFunction.btAnim",(float) (0),(float) (-mostCurrent._activity.getHeight()),(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0))),(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0))));
 //BA.debugLineNum = 87;BA.debugLine="btAnim.SetInterpolator(btAnim.INTERPOLATOR_BOUNCE";
mostCurrent._btanim.SetInterpolator(mostCurrent._btanim.INTERPOLATOR_BOUNCE);
 //BA.debugLineNum = 88;BA.debugLine="btAnim.Duration = 1500";
mostCurrent._btanim.setDuration((long) (1500));
 //BA.debugLineNum = 89;BA.debugLine="btAnim.Start(ImageView1)	'Jlaankan animasi pada o";
...
public static String  _button2_click() throws Exception{
 ...
 //BA.debugLineNum = 96;BA.debugLine="StartActivity(current_pos)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._current_pos.getObject()));
 //BA.debugLineNum = 97;BA.debugLine="End Sub";
return "";
}
public static String  _button3_click() throws Exception{
 //BA.debugLineNum = 98;BA.debugLine="Sub Button3_Click";
 //BA.debugLineNum = 99;BA.debugLine="StartActivity(pencarian)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._pencarian.getObject()));
 //BA.debugLineNum = 100;BA.debugLine="End Sub";
return "";
}
public static String  _button4_click() throws Exception{
 //BA.debugLineNum = 101;BA.debugLine="Sub Button4_Click";
 //BA.debugLineNum = 102;BA.debugLine="StartActivity(report)";
...
public static String  _button5_click() throws Exception{
 ...
 //BA.debugLineNum = 105;BA.debugLine="StartActivity(radius)";
...
mostCurrent._imageview1 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 32;BA.debugLine="Public btAnim As AnimationPlus  'animasi object b";
...
mostCurrent._button4 = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 37;BA.debugLine="Private Button5 As Button";
...
mostCurrent._panel1 = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 39;BA.debugLine="Private ImageView2 As ImageView";
mostCurrent._imageview2 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 40;BA.debugLine="Private about As TabHost";
mostCurrent._about = new anywheresoftware.b4a.objects.TabHostWrapper();
 //BA.debugLineNum = 41;BA.debugLine="Private ScrollView1 As ScrollView";
...
current_pos._process_globals();
pencarian._process_globals();
report._process_globals();
radius._process_globals();
informasi._process_globals();
location_route._process_globals();
gallery._process_globals();
takecam._process_globals();
takevid._process_globals();
scrollview._process_globals();
 ...
 //BA.debugLineNum = 20;BA.debugLine="Dim Server=\"http://gisnaturaldisaster.herokuapp.c";
_server = "http://gisnaturaldisaster.herokuapp.com/mobile/";
 //BA.debugLineNum = 23;BA.debugLine="Dim tmSplash As Timer 'timer untuk animasi splash";
_tmsplash = new anywheresoftware.b4a.objects.Timer();
 //BA.debugLineNum = 24;BA.debugLine="End Sub";
return "";
}
public static String  _tmsplash_tick() throws Exception{
 //BA.debugLineNum = 71;BA.debugLine="Sub tmSplash_Tick";
 //BA.debugLineNum = 72;BA.debugLine="tmSplash.Enabled = False 'disable timer";
_tmsplash.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 73;BA.debugLine="Activity.RemoveAllViews 'Hapus Design pada layout";
mostCurrent._activity.RemoveAllViews();
 //BA.debugLineNum = 74;BA.debugLine="Activity.LoadLayout(\"home\") 'load layout lyHome";
mostCurrent._activity.LoadLayout("home",mostCurrent.activityBA);
 //BA.debugLineNum = 75;BA.debugLine="about.AddTab(\"Home\",\"scroll.bal\")";
mostCurrent._about.AddTab(mostCurrent.activityBA,"Home","scroll.bal");
 //BA.debugLineNum = 76;BA.debugLine="about.AddTab(\"About\",\"about.bal\")";
mostCurrent._about.AddTab(mostCurrent.activityBA,"About","about.bal");
 //BA.debugLineNum = 78;BA.debugLine="ScrollView1.Panel.LoadLayout(\"homeket\")";
mostCurrent._scrollview1.getPanel().LoadLayout("homeket",mostCurrent.activityBA);
