...
views.get("webview1").vw.setHeight((int)((47d / 100 * height) - ((13d / 100 * height))));
views.get("spinner1").vw.setLeft((int)((10d / 100 * width)));
views.get("spinner1").vw.setWidth((int)((40d / 100 * width) - ((10d / 100 * width))));
views.get("spinner1").vw.setTop((int)((48d / 100 * height)));
views.get("spinner1").vw.setHeight((int)((55d / 100 * height) - ((48d / 100 * height))));
views.get("spinner2").vw.setLeft((int)((10d / 100 * width)));
views.get("spinner2").vw.setWidth((int)((40d / 100 * width) - ((10d / 100 * width))));
views.get("spinner2").vw.setTop((int)((55d / 100 * height)));
views.get("spinner2").vw.setHeight((int)((62d / 100 * height) - ((55d / 100 * height))));
views.get("spinner3").vw.setLeft((int)((40d / 100 * width)));
views.get("spinner3").vw.setWidth((int)((70d / 100 * width) - ((40d / 100 * width))));
views.get("spinner3").vw.setTop((int)((48d / 100 * height)));
views.get("spinner3").vw.setHeight((int)((55d / 100 * height) - ((48d / 100 * height))));
views.get("spinner4").vw.setLeft((int)((40d / 100 * width)));
views.get("spinner4").vw.setWidth((int)((70d / 100 * width) - ((40d / 100 * width))));
views.get("spinner4").vw.setTop((int)((55d / 100 * height)));
views.get("spinner4").vw.setHeight((int)((62d / 100 * height) - ((55d / 100 * height))));
views.get("button6").vw.setLeft((int)((70d / 100 * width)));
views.get("button6").vw.setWidth((int)((90d / 100 * width) - ((70d / 100 * width))));
views.get("button6").vw.setTop((int)((48d / 100 * height)));
views.get("button6").vw.setHeight((int)((62d / 100 * height) - ((48d / 100 * height))));
views.get("listview1").vw.setLeft((int)((10d / 100 * width)));
views.get("listview1").vw.setWidth((int)((90d / 100 * width) - ((10d / 100 * width))));
views.get("listview1").vw.setTop((int)((63d / 100 * height)));
views.get("listview1").vw.setHeight((int)((89d / 100 * height) - ((63d / 100 * height))));
